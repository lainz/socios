...
begin
  ...
  // Tabla Cuotas v1
  SQLite3Connection1.ExecuteDirect('CREATE TABLE IF NOT EXISTS cuotas(id varchar(36) NOT NULL PRIMARY KEY, idsocio varchar(36) NOT NULL, mes int, anio int, eliminado varchar(1))');
